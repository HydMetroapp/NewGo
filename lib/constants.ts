...
export const METRO_STATIONS_DATA = [
  ...
  },
  {
    ...
    latitude: 17.4851,
    longitude: 78.4075,
    facilities: ['Parking', 'ATM', 'Restroom', 'Food Court'],
  },
  {
    id: 'balanagar',
    name: 'Balanagar',
  ...
  },
  {
    ...
    latitude: 17.4375,
    longitude: 78.4483,
    facilities: ['Parking', 'ATM', 'Restroom', 'Food Court', 'Shopping'],
  },
  {
    id: 'punjagutta',
    name: 'Punjagutta',
    ...
    latitude: 17.4306,
    longitude: 78.4569,
    facilities: ['ATM', 'Restroom', 'Shopping'],
  },
  {
    id: 'irrum-manzil',
    name: 'Irrum Manzil',
  ...
  },
  {
    ...
    latitude: 17.3472,
    longitude: 78.5603,
    facilities: ['Parking', 'ATM', 'Restroom', 'Shopping'],
  },
  {
    id: 'chaitanyapuri',
    name: 'Chaitanyapuri',
...
export const METRO_LINES = {
  RED_LINE: {
    name: 'Red Line',
    color: '#DC2626',
    stations: METRO_STATIONS_DATA.filter((station) => station.line === 'RED_LINE').map(
  ...
  GREEN_LINE: {
    name: 'Green Line',
    color: '#16A34A',
    stations: METRO_STATIONS_DATA.filter((station) => station.line === 'GREEN_LINE').map(
      (station) => station.name,
    ),
  },
  BLUE_LINE: {
    name: 'Blue Line',
    color: '#2563EB',
    stations: METRO_STATIONS_DATA.filter((station) => station.line === 'BLUE_LINE').map(
      (station) => station.name,
    ),
  },
}
